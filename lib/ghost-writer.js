...
function GhostWriter(template) {
  ...
  exports.toMarkdown = function(filename, text, template) {
    // Create a new instance of the Ghost Writer
    var ghostWriter = new GhostWriter(template);
    // Convert the code to markdown
    return ghostWriter.convertScriptToMarkdown(filename, text);
  };